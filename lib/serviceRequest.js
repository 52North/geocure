...
function getFeatureRequestURL(req, WFSCache, services) {
  ...
  var outputformat = "outputFormat=" + checkedQuery.format? getDefaultFormatFeatures(req, services) :  checkedQuery.format;
  console.log("checkedQuery.format? " + checkedQuery.format);
  console.log("Outputformat " + outputformat);

  var requestURL = baseURL + service + "&" + version + "&" + request + "&" + "typeName=" + featureID + "&" + "outputFormat=" + outputformat
