...
function getMapRequestURL(params, serviceCache, services) {
    ...
    var width = !checkedQuery.width ? services[0].defaultWidth : checkedQuery.width;

    var height = !checkedQuery.height ? services[0].defaultHeight : checkedQuery.height;

    var format = !checkedQuery.format ? services[0].defaultFormat : checkedQuery.format;
