...
server.get({
    ...
    // var bbox = helpingFunctions.getRequestBBOX(ServiceGetCapabilities);  TODO Boundingbox aus getGapabilities konstruieren für request
    //var width = ??;
    //var height = ??;
    var format = "format=image/png";
    res.send(baseURL + service + "&" + version + "&" + request + "&" + layers);
});
