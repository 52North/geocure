...
var fs = require("fs");
var errors = require('restify-error');
...
server.get({
    ...
    //res.send(ServiceGetCapabilities.WMS_Capabilities.capability.layer);
    ...
    // res.send(ServiceGetCapabilities);
    ...
    var width = "width=" + 1330;
    var height = "height=" + 944
