...
server.get({
    ...
    if(helpingFunctions.errorHandling(services, req.params.id, serviceCache)){
...
server.get({
    ...
    var getCapabilities = json;
    var id = req.params.id;

    var requestUrl = helpingFunctions.getRequestURL(layer, bbox, crs, width, height,
        ServiceGetCapabilities, services, id, format);
...
server.get({
    ...
    var getCapabilities = serviceCache.getServices()[req.params.id];
    helpingFunctions.errorHandling(services, "COLABIS_REST_TEST", getCapabilities);
...
server.get({
    ...
    var getCapabilities = serviceCache.getServices()["COLABIS_REST_TEST"];
    var val = helpingFunctions.errorHandling(services, "COLABIS_REST_TEST", getCapabilities);
    res.send(val);
});
