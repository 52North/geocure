...
function getGetCapabilitiesURL(capabilitiesArray, service) {
    console.log("At function getCapabilitiesUrl()");
    var checkedRequest = processJSON.getKeyValueObject(capabilitiesArray, "id", service);
...
function getBaseURL(capabilitiesArray, service) {
    console.log("At getBaseURL()");
    var checkedRequest = processJSON.getKeyValueObject(capabilitiesArray, "id", service);
    // Construct the URL for the getCapabilites
    // Check checkedRequest! Fehlerbehandlung!
    var getBaseURL = processJSON.baseURLService;
