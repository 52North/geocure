...
function getGetCapabilitiesURL(objectArray, serviceId) {
    ...
    return checkedRequest.capabilities.maps ? (checkedRequest.baseURLService + "wms?request=GetCapabilities&service=wms") : null;
}
...
function getGetCapabilitiesURLWFS(objectArray, serviceId) {
    ...
    var checkedRequest = getKeyValueObject(objectArray, "id", serviceId);
    return checkedRequest.capabilities.features ? (checkedRequest.baseURLService + "wfs?request=GetCapabilities&service=wfs&version=1.1.0") : null;
}
