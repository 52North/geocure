...
function getFeatureInfo(services, WFSCache, req) {
    ...
    var mapinfo = new mapInfoTemplate(); // Need it to fill it in the following lines with information
    var features = getAllFeaturesInfo(getCapabilities, req); // Accessing the layer-section of the GetCapabilitie-Json
    return features;
    // console.log("Layerlength = " + layer.length);
    // //console.log(layer);
    //
...
**/
function getAllFeaturesInfo(getCapabilities, req) {
    const featureTypeList = getAllFeatures(getCapabilities, req);
