...
function getServiceInfo(services, serviceCache, req) {
    ...
    response.capabilities.push(checkedRequest.capabilities[0].maps ? req.fullUrl + "/maps" : "");
    response.capabilities.push(checkedRequest.capabilities[0].features ? req.fullUrl + "/features" : "");
